...
public class DiscoverTab_Screen 
{
	...
	// 	CONFIGURING ALL THE ITEMS INSIDE A COLLECTION
	
	
	public static String idcollectionTitle() 
	{
		String idcollectionTitle = "com.imaginea.fontli:id/collectionTitle";
		return idcollectionTitle;
	}
	
	public static String nameFollowbutton() 
	{
		String nameFollowbutton = "FOLLOW";
		return nameFollowbutton;
	}	
	
	public static String nameProfileFollowbutton() 
	{
		String nameProfileFollowbutton = "Follow";
		return nameProfileFollowbutton;
	}
	
	public static String idFollowbutton() 
	{
		String idFollowbutton = "com.imaginea.fontli:id/followButtonText";
		return idFollowbutton;
	}
	
	public static String idProfileFollowbutton() 
	{
		String idProfileFollowbutton = "com.imaginea.fontli:id/followButton";
		return idProfileFollowbutton;
	}
	
	public static String xFollowbutton() 
	{
		String xFollowbutton = "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/android.widget.RelativeLayout[1]/android.widget.LinearLayout[1]/android.widget.TextView[1]";
		return xFollowbutton;
	}
